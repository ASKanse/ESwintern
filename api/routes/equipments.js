...
router.get('/',(req,res,next) => {
  Equip.find()
  .select('_id UserID Catagory SubCatagory EquipmentName Manufacturer EqorTrk Model Value PreminumRate Hourly Daily Weekly Monthly Capacity Weight Param1 Param2 EqImg EqLogo')
  .exec()
  .then(docs => {
      const response = {
