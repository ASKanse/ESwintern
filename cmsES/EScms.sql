...
--
-- Table structure for table `marathiblog`
--

CREATE TABLE `marathiblog` (
  `blog_id` int(11) NOT NULL,
  `b_position` int(1) DEFAULT NULL COMMENT '0-top 1-side',
  `b_name` varchar(255) NOT NULL,
  `b_desc` text NOT NULL,
...
--
-- Table structure for table `hindiblog`
--

CREATE TABLE `hindiblog` (
  `blog_id` int(11) NOT NULL,
  `b_position` int(1) DEFAULT NULL COMMENT '0-top 1-side',
  `b_name` varchar(255) NOT NULL,
  `b_desc` text NOT NULL,
...
--
-- Table structure for table `gujratiblog`
--

CREATE TABLE `gujratiblog` (
  `blog_id` int(11) NOT NULL,
  `b_position` int(1) DEFAULT NULL COMMENT '0-top 1-side',
  `b_name` varchar(255) NOT NULL,
  `b_desc` text NOT NULL,
...
--
-- Table structure for table `telugublog`
--

CREATE TABLE `telugublog` (
  `blog_id` int(11) NOT NULL,
  `b_position` int(1) DEFAULT NULL COMMENT '0-top 1-side',
  `b_name` varchar(255) NOT NULL,
  `b_desc` text NOT NULL,
...
--
-- Table structure for table `tamilblog`
--

CREATE TABLE `tamilblog` (
  `blog_id` int(11) NOT NULL,
  `b_position` int(1) DEFAULT NULL COMMENT '0-top 1-side',
  `b_name` varchar(255) NOT NULL,
  `b_desc` text NOT NULL,
...
--
-- Table structure for table `malayalamblog`
--

CREATE TABLE `malayalamblog` (
  `blog_id` int(11) NOT NULL,
  `b_position` int(1) DEFAULT NULL COMMENT '0-top 1-side',
  `b_name` varchar(255) NOT NULL,
  `b_desc` text NOT NULL,
